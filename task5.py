...
class ContactManagerApp:
    ...
    def create_widgets(self):
        tk.Label(self.master, text="Contact Manager", font=("Arial", 18), bg="#e3f2fd").pack(pady=10)

        self.add_button = tk.Button(self.master, text="Add Contact", command=self.add_contact, font=("Arial", 14), bg="#42a5f5", fg="#ffffff")
        self.add_button.pack(pady=5)

        self.view_button = tk.Button(self.master, text="View Contacts", command=self.view_contacts, font=("Arial", 14), bg="#42a5f5", fg="#ffffff")
        self.view_button.pack(pady=5)

        self.search_button = tk.Button(self.master, text="Search Contact", command=self.search_contact, font=("Arial", 14), bg="#42a5f5", fg="#ffffff")
        self.search_button.pack(pady=5)

        self.update_button = tk.Button(self.master, text="Update Contact", command=self.update_contact, font=("Arial", 14), bg="#42a5f5", fg="#ffffff")
        self.update_button.pack(pady=5)

        self.delete_button = tk.Button(self.master, text="Delete Contact", command=self.delete_contact, font=("Arial", 14), bg="#42a5f5", fg="#ffffff")
