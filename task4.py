...
class RockPaperScissorsApp:
    ...
    def create_widgets(self):
        ...
        self.choice_menu.configure(font=("Arial", 14), bg="#bbdefb", borderwidth=2)
        ...
        self.result_label = tk.Label(self.master, text="", font=("Arial", 14), bg="#e3f2fd")
        self.result_label.pack(pady=20)

        self.score_label = tk.Label(self.master, text="User: 0  Computer: 0", font=("Arial", 14), bg="#e3f2fd")
